...
int main()
{
typedef map<string,int> mapType; //syntax for defining map container

mapType populationMap;// create empty map

populationMap.insert(pair<string, int>("Maharashtra", 7026357)); //inser elements into map(random order)
...
mapType::iterator iter;// iterator/index for map
