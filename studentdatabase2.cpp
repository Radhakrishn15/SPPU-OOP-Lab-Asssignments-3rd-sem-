...
private:
    ...
    int div;
public:
    friend class Faculty;//faculty friend of student
...
class Faculty
{
   private:
    ...
    public:
       ...
       void fdisplay(Student &obj,int fd)
       {
           try
           {
               if(obj.div==fd)
           ...
           {
               cout<<"\n Invalid division/you are not teaching to this division...";
           }
       }
};
